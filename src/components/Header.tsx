        ...
        <header className="w-full flex justify-between items-center pt-9 select-none">
            ...
            <div className="flex flex-col gap-y-3 ">
                ...
                <Modal id="instruction-modal">
                    ...
                    <p>Порядок работы с установкой в общем случае следующий:
                        <ol className="list-decimal pl-4">
                            <li>Сбрасываем текущее состоянии установки кнопкой “сброс” на табло.</li>
                            <li>Выставляем оптические ворота и тележку, перетаскивая мышкой. Устанавливаем количество брусков (пластин) с помощью кнопок около левой опоры.</li>
                            <li>Включаем насос, нажав на его кнопку (зеленый цвет индикатора - насос работает, красны - насос вылключен).</li>
                            <li>Проверяем текущую активную строку в таблице, именно в нее запишутся снятые данные (строка подсвечивается синим цветом).</li>
                            <li>Если выбрана неверная строка - с помощью стрелок нужно выбрать верную.</li>
                            <li>Если вы хотите перезаписать результат - нажать на кнопку сброса около активной строки, после чего снять верные данные</li>
